<h2><a href="https://www.geeksforgeeks.org/problems/type-it--170645/1?page=2&category=Strings&difficulty=Easy&status=unsolved&sortBy=submissions">Type it!</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek is extremely punctual&nbsp;but today even he is not feeling like doing his homework assignment. He must start doing it immediately in order to meet the&nbsp;deadline. For the assignment, Geek needs to type a&nbsp;string <strong>s</strong>.<br>
