<h2><a href="https://www.geeksforgeeks.org/problems/stack-problem/1?page=2&category=Java-Collections&difficulty=Easy&status=unsolved&sortBy=submissions">Stack Problem</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Java provides an inbuilt object type called&nbsp;<strong>Stack</strong>. It is a collection that is based on the last in first out (LIFO) principle. Try this problem using Stack.&nbsp;</span></p>
