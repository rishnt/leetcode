<h2><a href="https://www.geeksforgeeks.org/problems/learn-to-comment/1?page=3&difficulty=Easy&status=unsolved&sortBy=submissions">Learn to Comment</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a code that prints three<strong>&nbsp;</strong>integers <strong>a</strong>, <strong>b</strong>, and <strong>c</strong>. You need to comment on the line of code that prints the integer b such that this line does not compile.</span></p>
