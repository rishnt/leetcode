<h2><a href="https://www.geeksforgeeks.org/problems/last-index-of-15847/1?page=4&category=Data%20Structures&difficulty=Easy&status=unsolved&sortBy=submissions">Last index of One</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s</strong> consisting of only '<strong>0</strong>'s and '<strong>1</strong>'s,&nbsp; find the last index of the '1' present.<br></span></p>
