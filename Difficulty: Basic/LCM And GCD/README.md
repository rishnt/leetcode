<h2><a href="https://www.geeksforgeeks.org/problems/lcm-and-gcd4516/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">LCM And GCD</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given two integers a and b, You have to compute their LCM and GCD and return an array containing their LCM and GCD.</span></p>
